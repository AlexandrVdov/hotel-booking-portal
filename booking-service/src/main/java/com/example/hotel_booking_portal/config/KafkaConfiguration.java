package com.example.hotel_booking_portal.config;
...
public class KafkaConfiguration {
    ...
    @Bean
    public KafkaTemplate<String, BookingEvent> bookingEventKafkaTemplate(ProducerFactory<String, BookingEvent> bookingEventProducerFactory) {
